...
- Bump version from 0.1.24 to 0.2.0
...
### Added
- Bump version from 0.1.21 to 0.1.22
...
- Bump version from 0.1.19 to 0.1.20
...
- Bump version from 0.1.18 to 0.1.19
...
### Added
- Initial plan
- Implement major UI and config enhancements - settings button, version display, scroll frames, auto cleanup
- Validate and improve TitanPanel API compliance with robust fallbacks
- Merge pull request #48 from djdefi/copilot/fix-47
...
### Added
- Initial plan
- Fix major 0.1.6 issues: UI initialization, over-counting, unknown players, and notification spam
- Final fix: Allow apostrophes in player names and add comprehensive testing
- Fix trailing whitespace on line 261 in Tracker.lua
- Add location-based duplicate detection to prevent counting players who log in/out or die/resurrect in same spot
- Merge pull request #20 from djdefi/copilot/fix-19
